    ...
    <div className="min-h-screen relative z-10 px-6 py-8">
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="backdrop-blur-md bg-white/10 rounded-2xl p-3 border border-white/20 shadow-2xl mb-8 animate-slide-up">
          ...
          {/* Updated flex container with responsive classes */}
          <div className="flex flex-col sm:flex-row gap-3 mb-6">
            ...
            <button
              onClick={handleAdd}
              className="group bg-gradient-to-r from-green-500 to-blue-600 hover:from-green-400 hover:to-blue-500 text-white px-6 py-3 rounded-xl font-semibold transition-all duration-300 hover:scale-105 shadow-lg hover:shadow-green-500/25 w-full sm:w-auto"
            >
